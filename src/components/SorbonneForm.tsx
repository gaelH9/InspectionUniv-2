...
export function SorbonneForm({
  ...
  return (
    <div>
      ...
      <div className="bg-gradient-to-r from-green-600 to-green-700 text-white text-center py-2 rounded-lg mb-4 font-bold text-xl tracking-wide shadow-sm">
        SORBONNE
      </div>
      ...
      <div className="grid grid-cols-4 gap-3 mb-4">
        ...
        <div className="border rounded-lg p-2 flex items-center bg-gray-50 shadow-sm">
          <span className="text-xs font-bold min-w-16 text-gray-700">S/N:</span>
          <span className="text-xs flex-1">{selectedCabinet.reference}</span>
        </div>
      </div>
